// src/features/ads/ui/components/filter/DeedStatusBox.client.tsx
"use client";
...
type Props = {
  ...
  /**
   * FilterState içinde tapu durumunu tuttuğun alan adı.
   * Varsayılan: "deedStatus"
   * Çoklu seçim için string[] tutuyoruz.
   */
  filterKey?: string;
  ...
  /**
   * Seçenekler. Vermezsen TR'de yaygın olan + görseldekiler gelir.
   */
  options?: string[];
...
export default function DeedStatusBox({
  filters,
  setFilters,
  filterKey = "deedStatus",
  title = "Tapu Durumu",
  defaultOpen = true,
