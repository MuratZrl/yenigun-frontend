// src/features/ads/ui/components/filter/CreditEligibleBox.client.tsx
"use client";
...
type Props = {
  ...
  /**
   * FilterState içinde krediye uygunluk bilgisini tuttuğun alan.
   * Varsayılan: "creditEligible"
...
export default function CreditEligibleBox({
  filters,
  setFilters,
  filterKey = "creditEligible",
  title = "Krediye Uygun",
  defaultOpen = true,
