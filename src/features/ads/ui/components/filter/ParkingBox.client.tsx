// src/features/ads/ui/components/filter/ParkingBox.client.tsx
"use client";
...
type Props = {
  ...
  /**
   * FilterState içinde otopark bilgisini tuttuğun alan adı.
   * Varsayılan: "parking"
   * Not: Çoklu seçim için string[] tutuyoruz.
   */
  filterKey?: string;
  ...
  /**
   * Kısa liste ama pattern aynı kalsın.
   */
  maxHeightClass?: string;

  /**
   * Seçenekler. Vermezsen görseldeki gibi default gelir.
   */
  options?: string[];
...
const DEFAULT_OPTIONS = ["Açık Otopark", "Kapalı Otopark", "Açık & Kapalı Otopark", "Yok"];

export default function ParkingBox({
  filters,
  setFilters,
  filterKey = "parking",
  title = "Otopark",
