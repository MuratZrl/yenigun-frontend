// src/features/ads/ui/components/filter/UsageStatusBox.client.tsx
"use client";
...
type Props = {
  ...
  /**
   * FilterState içinde kullanım durumunu tuttuğun alan adı.
   * Varsayılan: "usageStatus"
...
const DEFAULT_OPTIONS = ["Boş", "Kiracılı", "Mülk Sahibi"];

export default function UsageStatusBox({
  filters,
  setFilters,
