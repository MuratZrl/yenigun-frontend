...
import { renderLocationSafely, renderAddressSafely } from "../../emlak-archived/utils/addressFormat";
import { hasValidPhotos, getFirstValidPhoto } from "../../emlak-archived/utils/photoHelpers";
