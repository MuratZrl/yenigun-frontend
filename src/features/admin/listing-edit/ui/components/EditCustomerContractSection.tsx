// src/features/admin/listing-edit/ui/components/EditCustomerContractSection.tsx
"use client";

import React from "react";
import Select from "react-select";

import type { FormData, Advisor } from "@/types/property";
import type Customer from "@/types/customers";
import type { FormDataValue } from "../../model/types";
import { selVal, turkishFilterOption } from "../../model/utils";

import Section from "./Section";
import FieldRow from "./FieldRow";
import { inputCls, selectCls, selectStyles } from "./styles";

interface EditCustomerContractSectionProps {
  fourthStep: FormData;
