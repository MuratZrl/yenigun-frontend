// src/features/home/types/ui/TypesSlider.client.tsx
"use client";
...
import TypeCard from "./TypeCard.client";
...
export default function TypesSlider({ items }: Props) {
      ...
      >
        {items.map((item, index) => (
          <SwiperSlide key={item.title}>
            <TypeCard item={item} index={index} />
          </SwiperSlide>
        ))}
      </Swiper>
